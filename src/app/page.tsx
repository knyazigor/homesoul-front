          ...
          <div className="container">
            ...
            <div className={styles.aboutContent}>
              <div className={styles.aboutText}>
                <p>
                  Я — дизайнер интерьера Полина Квашнина и я верю, что интерьер
                  — это отражение души. Я вижу, что за каждой сметой стоит стоит
                  человек, а за каждым кирпичом — мечта. Но чтобы ваш внутренний
                  мир обрел форму в бетоне и дереве, нужен не просто художник,
                  нужен Руководитель.
                </p>
                <p>
                ...
                <p>
                  Я беру на себя полную ответственность за результат и
                  архитектуру вашего пространства.
                </p>
              </div>
            ...
            <ol className={styles.features}>
              <li>
                <span className={styles.strong}>Взаимное уважение</span>
                <span>
                  Я управленец в третьем поколении и мать троих сыновей. Я умею
              ...
              <li>
                <span className={styles.strong}>Системность против хаоса</span>
                <span>
                  Мой опыт в промышленной метрологии позволяет мне видеть
                  проект, как единую подвижную систему. Если ремонт подбрасывает
                  сюрпризы, я принимаю решение на месте.
                </span>
              </li>
            </ol>
          </div>
